    ...
    <section id="funcionalidades" className="py-24 bg-background">
      <div className="container space-y-14">
        <Reveal className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg">Funcionalidades pensadas para donos de negócios locais.</p>
        </Reveal>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <Reveal key={i} delay={i * 80}>
              <div className="group rounded-2xl border border-border bg-card p-7 space-y-4 shadow-soft card-hover h-full">
